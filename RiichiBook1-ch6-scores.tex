...
\bigskip
Once you rule out the first three cases ({\jap chiitoitsu}, quads, and \linebreak {\jap toitoi}), the last three are the most important ones; the great majority of hands you see will be one of these three. Here, you check two things. 
...
\bp
\wan{2}\wan{2}\tong{4}\tong{5}\suo{2}\suo{3}\suo{4}\suo{6}\suo{7}\suo{8}~\rwan{3}\wan{4}\wan{5}\\
\ep
...
\bigskip
If you win this hand on {\LARGE\wan{2}}, the hand is still 1 {\jap han}--40 minipoints = 1300. However, if you win on {\LARGE\tong{5}} or {\LARGE\tong{8}}, the three tiles of {\LARGE\tong{5}} within the hand are treated as a concealed set, giving you 4 additional minipoints: 20 (base) + 10 (closed {\jap ron}) + 8 (set of \zhong) + 4 (set of \tong{5}) = 42, rounded up to 50 minipoints. You thus get 1 {\jap han}--50 minipoints = 1600 points. If you win by {\jap tsumo}, you get 40 minipoints so you will get 700-1300 = 2700 points. 
...
\bigskip
If you win the hand by {\jap ron} on {\LARGE\wan{4}}, you get an additional {\jap yaku}, \linebreak {\jap iipeiko} (Pure Double Chow), giving you 2 {\jap han}--40 minipoints = 2600 points. 
