...
\bigskip Let me explain each component of this principle in turn. 
...
I introduced the term {\jap genbutsu} in the previous chapter. Strictly \linebreak speaking, {\jap genbutsu} tiles of player X refer to those tiles discarded by X himself. However, if X has called riichi, then all the tiles discarded by anyone after riichi (and passed up by X) are also called X's {\jap genbutsu} tiles. 
...
Note that {\LARGE\wan{9}} and {\LARGE\tong{2}} do not create any {\jap suji} tiles on their own. \linebreak Among these three tiles {\LARGE\wan{4}\tong{6}\suo{5}}, {\jap suji} tiles of {\LARGE\wan{4}} are relatively safe, whereas {\jap suji} tiles of {\LARGE\suo{5}} are rather dangerous. 
...
\newpage
\bp
\hspace{54pt}{\footnotesize\color{red!75!black} Red}\\ \vspace{-16pt}
...
\bigskip
Second, one-chance tiles are more reliable when the incomplete \linebreak blockade that makes for a one-chance tile is known \emph{only to you}, thanks to a concealed set or a pair in your hand. On the other hand, one-chance tiles that are created by an incomplete blockade in the discard pool are not particularly safe. This is because an opponent is more likely to choose riichi over {\jap dama} when one of his winning tiles is a one-chance tile and appears safe.
...
Discard pairs and concealed sets. Once you get one tile passed \linebreak against a riichi'ed player, you can be safe for the next turn or two. 
...
\vspace{-20pt}
\bp
\hspace{118pt}{\footnotesize\color{red!75!black} Red}\\ \vspace{-16pt}\suo{30}\suo{30}\suo{30}\suo{30}
\rsuo{1}\suo{1}\suo{1}~\rsuo{4}\suo{3}\rfs~\rsuo{6}\suo{7}\suo{8}
\ep

\bigskip
A hand like above has a minimum of 3900 and a maximum of \linebreak {\jap haneman} if you deal into it with a {\jap souzu} tile. You should fold when you draw an unwanted {\jap souzu} tile.
