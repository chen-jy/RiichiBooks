...
\usepackage[paperwidth=148mm, paperheight=210mm, top=13mm, bottom = 13mm, inner=25mm, outer = 13mm, includehead, includefoot]{geometry}
\special{papersize=148mm,210mm}
% customizing section titles
\usepackage{titlesec}
\partfont{\raggedright\mdseries\scshape}
\titleformat{\chapter}[display]{\bf\LARGE}{Chapter \thechapter}{.1em}{}
