...
\bigskip
Looking at each of the five blocks, the pair of {\LARGE\wan{5}}, the protorun {\LARGE\wan{7}\wan{8}}, and the set of {\LARGE\zhong} are all self-sufficient; we keep them as they are. Our discard choice should thus be from the third or the fourth blocks, \linebreak {\LARGE\tong{2}\tong{4}\tong{5}\tong{5}} or {\LARGE\suo{1}\suo{3}\suo{3}}. 
...
\bp 
\hspace{119pt}{\footnotesize\color{red!75!black} Red}\\ \vspace{-16pt}
...
\bmj{\Huge
$ 
\text{\wan{1}\wan{3}\wan{5}\wan{7}\wan{7}}~
\text{\tong{3}}~
\text{\tong{7}\tong{8}}~
\text{\suo{3}\suo{4}}~
\text{\suo{8}\suo{8}}~
