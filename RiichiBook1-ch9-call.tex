...
\hfill\footnotesize{{\jap Dora}~~~~~~~~~}
\ep
\vspace{-15pt}The left player discarded {\LARGE\suo{3}} just now.
\end{itembox}
...
\hfill\footnotesize{{\jap Dora}~~~~~~~~~}
\ep
\vspace{-15pt}The left player discarded {\LARGE\tong{7}} just now.
\end{itembox}
...
\hfill\footnotesize{{\jap Dora}~~~~~~~~~}
\ep
\vspace{-15pt}The left player discarded {\LARGE\wan{7}} just now.
\end{screen}
...
\ep
\vspace{-5pt}The left player discarded {\LARGE\wan{5}} just now.
\end{itembox}
...
\hfill\footnotesize{{\jap Dora}~~~~~~~~~}
\ep
\vspace{-15pt}The left player discarded {\LARGE\suo{4}} just now.
\end{itembox}
...
\vspace{-15pt}The left player discarded {\LARGE\tong{2}} just now.
\end{itembox}
...
\hfill\footnotesize{{\jap Dora}~~~~~~~~~}
\ep
\vspace{-15pt}The left player discarded {\LARGE\wan{5}} just now.
\end{itembox}
...
%If you get {\jap rinshan tsumo} in addition, it will be {\jap mangan}. 
% Deleted the last sentence because in many rule sets (including Tenhou's) the new dora is added only after the player discards a tile upon drawing a rinshan tile.
...
\bigskip
We should definitely call {\jap chii} on {\LARGE\tong{6}} to make the hand ready, but the question here is: should we {\jap chii} with {\LARGE\tong{4}\tong{5}} or with {\LARGE\tong{7}\tong{8}}? Let's compare the resulting hands in each of the two possibilities. 
\bp
